        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 text-xs font-bold uppercase tracking-wider rounded flex items-center gap-1 transition-colors cursor-pointer"
            >
          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-2.5">
              ...
              {items.map((item, index) => (
                <div
                  key={item.id}
                  className="grid grid-cols-12 gap-2 items-center bg-slate-50 p-2 rounded-lg border border-slate-200/80 hover:border-blue-300 transition-all"
                >
                  {/* Item Code */}
                  <div className="col-span-3">
                    <input
                      ...
                      className="w-full text-xs bg-white border border-slate-200 rounded px-2.5 py-1.5 focus:ring-2 focus:ring-blue-500 font-mono text-slate-800"
                    />
                  </div>
                  ...
                  <div className="col-span-6">
                    <input
                      ...
                      className="w-full text-xs bg-white border border-slate-200 rounded px-2.5 py-1.5 focus:ring-2 focus:ring-blue-500 text-slate-800 font-medium"
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    <input
                      ...
                      className="w-full text-xs bg-white border border-slate-200 rounded px-2.5 py-1.5 focus:ring-2 focus:ring-blue-500 font-mono font-bold text-blue-600 text-right"
                    />
                  </div>
