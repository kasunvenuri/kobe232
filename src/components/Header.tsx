    ...
    <header className="h-16 bg-white border-b border-slate-200 text-slate-800 sticky top-0 z-30 shadow-2xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 bg-blue-600 rounded-sm flex items-center justify-center shadow-xs">
            <span className="text-white font-bold text-lg leading-none">K</span>
          </div>
          <div className="flex items-center space-x-2">
            <h1 className="text-xl font-bold tracking-tight text-slate-800">KOBE</h1>
            <span className="text-[11px] font-semibold bg-blue-50 text-blue-600 px-2.5 py-0.5 rounded border border-blue-100 uppercase tracking-widest hidden sm:inline-block">
              Aggregator
            </span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4 text-xs font-medium text-slate-500">
          ...
          <div className="flex items-center gap-2 bg-slate-900 text-white rounded px-3 py-1 border border-slate-800">
            ...
            <span className="text-blue-400 font-extrabold text-sm">{grandTotalQty.toLocaleString()}</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2.5 shrink-0">
          <button
            ...
            className="px-3 py-1.5 rounded bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
          >
