      ...
      <div className="p-6 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-slate-50/50">
        <div>
          <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
            Aggregated Summary
            <span className="text-xs font-semibold bg-blue-50 text-blue-600 px-2 py-0.5 rounded border border-blue-100 uppercase tracking-wider">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white rounded text-xs font-bold hover:bg-blue-700 uppercase tracking-wider transition-colors shadow-2xs cursor-pointer"
          >
      ...
      <div className="p-4 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-1.5 bg-white border border-slate-200 rounded text-xs focus:ring-2 focus:ring-blue-500 text-slate-800"
          />
        </div>
                  ...
                  <td className="px-6 py-4 font-mono text-xs text-blue-600 font-semibold">
                    <div className="flex items-center space-x-2">
                      ...
                      {item.breakdown.length > 1 && (
                        <span className="text-[10px] text-blue-700 bg-blue-50 px-1.5 py-0.5 rounded border border-blue-100 font-sans font-semibold">
