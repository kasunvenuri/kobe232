      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="bg-slate-900 text-white p-4 px-6 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            <div className="p-1.5 bg-yellow-500 text-zinc-950 rounded shadow-xs">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full text-xs border border-slate-200 rounded p-2.5 focus:ring-2 focus:ring-yellow-500 font-mono text-slate-800"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-xs border border-slate-200 rounded p-2.5 focus:ring-2 focus:ring-yellow-500 font-medium text-slate-800"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-xs border border-slate-200 rounded p-2.5 focus:ring-2 focus:ring-yellow-500 font-mono font-bold text-yellow-600"
            />
          </div>
